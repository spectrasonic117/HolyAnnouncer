package com.spectrasonic.HolyAnnouncer.Utils;
...
public final class MessageUtils {
    ...
    public static final String PREFIX = "&7[&f&lHoly Announcer&r&7] &6»&r ";
    ...
    public static void sendPermissionMesssage(CommandSender sender) {
        sender.sendMessage(colorize(PREFIX + "&cYou don't have permission to use this command!"));
    }
